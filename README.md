...
O **Luiz0067 Card Trainer** é uma solução completa para produtores de conteúdo educacional, cursos online, plataformas EAD e blogs em WordPress que desejam transformar o aprendizado em uma experiência gamificada e envolvente. 
...
├── luiz0067-card-trainer.php   # Registro do plugin, enqueues e i18n
...
- **Sem conflitos de CSS**: Namespace isolado `.luiz0067-card-trainer` prevenindo choques com temas WordPress.
...
1. Faça o download ou clone este repositório para a pasta de plugins da sua instalação WordPress:
   ...
   git clone https://github.com/luiz0067yahoo/luiz0067-card-trainer.git
   ```
2. Acesse o **Painel Administrativo do WordPress** > **Plugins**.
3. Localize **Luiz0067 Card Trainer** e clique em **Ativar**.
