/**
 * Luiz0067 Card Trainer - Frontend Controller
...
(function () {
  ...
  function initCardTrainers() {
    const blocks = document.querySelectorAll('.wp-block-luiz0067-card-trainer');
    blocks.forEach((el) => {
      if (!el.__luiz0067CardTrainerInstance) {
        el.__luiz0067CardTrainerInstance = new CardTrainer(el);
      }
    });
  }
  ...
  window.initLuiz0067CardTrainer = initCardTrainers;
})();
